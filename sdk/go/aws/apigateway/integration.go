...
type Integration struct {
	...
	CacheKeyParameters pulumi.ArrayOutput `pulumi:"cacheKeyParameters"`
	...
	IntegrationHttpMethod pulumi.StringOutput `pulumi:"integrationHttpMethod"`
	...
	RequestTemplates pulumi.MapOutput `pulumi:"requestTemplates"`
...
func NewIntegration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws:apigateway/integration:Integration", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIntegration(ctx *pulumi.Context,
	...
	var resource Integration
	err := ctx.ReadResource("aws:apigateway/integration:Integration", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (r *Integration) GetURN() pulumi.URNOutput {
	return r.URN
}

// GetID returns this resource's unique identifier assigned by its provider.
func (r *Integration) GetID() pulumi.IDOutput {
	return r.ID
}
// Input properties used for looking up and filtering Integration resources.
type IntegrationState struct {
	// A list of cache key parameters for the integration.
	CacheKeyParameters pulumi.ArrayInput `pulumi:"cacheKeyParameters"`
	// The integration's cache namespace.
	CacheNamespace pulumi.StringInput `pulumi:"cacheNamespace"`
	// The id of the VpcLink used for the integration. **Required** if `connectionType` is `VPC_LINK`
	...
	// Not all methods are compatible with all `AWS` integrations.
	// e.g. Lambda function [can only be invoked](https://github.com/awslabs/aws-apigateway-importer/issues/9#issuecomment-129651005) via `POST`.
	IntegrationHttpMethod pulumi.StringInput `pulumi:"integrationHttpMethod"`
	// The integration passthrough behavior (`WHEN_NO_MATCH`, `WHEN_NO_TEMPLATES`, `NEVER`).  **Required** if `requestTemplates` is used.
	PassthroughBehavior pulumi.StringInput `pulumi:"passthroughBehavior"`
	// A map of request query string parameters and headers that should be passed to the backend responder.
	// For example: `requestParameters = { "integration.request.header.X-Some-Other-Header" = "method.request.header.X-Some-Header" }`
	RequestParameters pulumi.MapInput `pulumi:"requestParameters"`
	// A map of the integration's request templates.
	RequestTemplates pulumi.MapInput `pulumi:"requestTemplates"`
	// The API resource ID.
