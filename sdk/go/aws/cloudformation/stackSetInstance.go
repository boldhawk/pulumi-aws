...
type StackSetInstance struct {
	...
	ParameterOverrides pulumi.MapOutput `pulumi:"parameterOverrides"`
...
func (r *StackSetInstance) GetURN() pulumi.URNOutput {
	return r.URN
}

// GetID returns this resource's unique identifier assigned by its provider.
func (r *StackSetInstance) GetID() pulumi.IDOutput {
	return r.ID
}
...
type StackSetInstanceState struct {
	...
	// Key-value map of input parameters to override from the Stack Set for this Instance.
	ParameterOverrides pulumi.MapInput `pulumi:"parameterOverrides"`
	// Target AWS Region to create a Stack based on the Stack Set. Defaults to current region.
