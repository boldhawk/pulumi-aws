...
func NewClusterSnapshot(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws:rds/clusterSnapshot:ClusterSnapshot", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterSnapshot(ctx *pulumi.Context,
	...
	var resource ClusterSnapshot
	err := ctx.ReadResource("aws:rds/clusterSnapshot:ClusterSnapshot", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
