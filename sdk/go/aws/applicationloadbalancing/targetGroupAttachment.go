...
func NewTargetGroupAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws:applicationloadbalancing/targetGroupAttachment:TargetGroupAttachment", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetGroupAttachment(ctx *pulumi.Context,
	...
	var resource TargetGroupAttachment
	err := ctx.ReadResource("aws:applicationloadbalancing/targetGroupAttachment:TargetGroupAttachment", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
