...
func NewLoadBalancer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws:applicationloadbalancing/loadBalancer:LoadBalancer", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoadBalancer(ctx *pulumi.Context,
	...
	var resource LoadBalancer
	err := ctx.ReadResource("aws:applicationloadbalancing/loadBalancer:LoadBalancer", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
