...
func NewTargetGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws:lb/targetGroup:TargetGroup", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTargetGroup(ctx *pulumi.Context,
	...
	var resource TargetGroup
	err := ctx.ReadResource("aws:lb/targetGroup:TargetGroup", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
