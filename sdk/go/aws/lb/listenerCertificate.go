...
func NewListenerCertificate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws:lb/listenerCertificate:ListenerCertificate", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetListenerCertificate(ctx *pulumi.Context,
	...
	var resource ListenerCertificate
	err := ctx.ReadResource("aws:lb/listenerCertificate:ListenerCertificate", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
