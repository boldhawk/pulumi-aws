...
func NewAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws:elasticloadbalancing/attachment:Attachment", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAttachment(ctx *pulumi.Context,
	...
	var resource Attachment
	err := ctx.ReadResource("aws:elasticloadbalancing/attachment:Attachment", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
